...
Board::Board()
{
	...
	_cases.push_back(new Case(CASE_0, "ressources/case.png", 50, 50,false));
	_cases.push_back(new Case(CASE_1, "ressources/case.png", 178, 50, false));
	_cases.push_back(new Case(CASE_2, "ressources/case.png", 306, 50, false));
	_cases.push_back(new Case(CASE_3, "ressources/case.png", 50, 178, false));
	_cases.push_back(new Case(CASE_4, "ressources/empty.png", 178, 178,true));
	_cases.push_back(new Case(CASE_5, "ressources/case.png", 306, 178, false));
	_cases.push_back(new Case(CASE_6, "ressources/case.png", 50, 306, false));
	_cases.push_back(new Case(CASE_7, "ressources/case.png", 178, 306, false));
	_cases.push_back(new Case(CASE_8, "ressources/case.png", 306, 306, false));
